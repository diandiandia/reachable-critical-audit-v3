...
def test_checklist_postop_invariant():
    ...
    assert len(ids) == 50  # v3.15 +1; v3.17 +5; v3.37 +2; v3.40 +1 (SWR-V3.40-003); v3.41 +1 (SWR-V3.41-005)
...
def test_tooling_version_and_skillmd():
    ...
    assert we.TOOLING_VERSION == "3.45"  # v3.13 版本链前进 (SWR-V3.13-006)
